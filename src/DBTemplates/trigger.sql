...
BEGIN
	...
	VALUES('INSERT','genre2','gbez',CONCAT('\'', NEW.gbez, '\',\'',New.gbez1),NULL,NOW());
END
|
DELIMITER ;
DELIMITER |
...
BEGIN
	INSERT INTO log_123 (act,tab,col,val,tim)
	VALUES('UPDATE','genre2','gbez',NEW.gbez,OLD.gbez,NOW());
END;
|
DELIMITER ;
DELIMITER |
...
BEGIN
	INSERT INTO log_123 (act,tab,col,val,tim)
	VALUES('DELETE','genre2','gbez',NULL,OLD.gbez,NOW());
END;
|
DELIMITER ;
